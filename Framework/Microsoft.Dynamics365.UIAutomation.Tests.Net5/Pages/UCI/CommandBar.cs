...
namespace Microsoft.Dynamics365.UIAutomation.Api.UCI
{
    public class CommandBar : Element
    {
        ...
        public void ClickCommand(string name, string subname, bool moreCommands)
        {
        ...
        /// <param name="name">Name of button to click</param>
        /// <param name="subname">Name of button on submenu to click</param>
        public void ClickCommand(string name, string subname)
        {
            ClickCommand(name, subname, false);
        }
        ...
        /// </summary>
        /// <param name="name">Name of button to click</param>
        public void ClickCommand(string name)
        {
            ClickCommand(name, "", false);
        }

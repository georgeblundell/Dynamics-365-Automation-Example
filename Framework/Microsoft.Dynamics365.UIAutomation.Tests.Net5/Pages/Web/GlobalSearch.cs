...
namespace Microsoft.Dynamics365.UIAutomation.Api
{
        ...
        : XrmPage
    {
        ...
        public BrowserCommandResult<bool> FilterWith(string entity)
        {
            return FilterWith(entity, Constants.DefaultThinkTime);
        }
        ...
        /// <example>xrmBrowser.GlobalSearch.FilterWith("Account");</example>
        public BrowserCommandResult<bool> FilterWith(string entity, int thinkTime)
        {
        ...
        public BrowserCommandResult<bool> OpenRecord(string entity, int index)
        {
            return OpenRecord(entity, index, Constants.DefaultThinkTime);
        }
        ...
        /// <example>xrmBrowser.GlobalSearch.OpenRecord("Accounts",0);</example>
        public BrowserCommandResult<bool> OpenRecord(string entity, int index, int thinkTime)
        {
            Browser.ThinkTime(thinkTime);
        ...
        public BrowserCommandResult<bool> Search(string criteria)
        {
            return Search(criteria, Constants.DefaultThinkTime);
        }
        ...
        /// <param name="thinkTime">Used to simulate a wait time between human interactions. The Default is 2 seconds.</param> time.</param>
        /// <example>xrmBrowser.GlobalSearch.Search("Contoso");</example>
        public BrowserCommandResult<bool> Search(string criteria, int thinkTime)
        {
            Browser.ThinkTime(thinkTime);
